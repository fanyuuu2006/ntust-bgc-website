  ...
  return (
    <div className={cn("space-y-4", className)} {...rest}>
      <form method="GET" action={BASE_PATH}>
        ...
        <div className="flex items-center gap-2 rounded-xl border border-(--border) bg-(--secondary-background) px-3 py-1.5">
          <input
            ...
            className="min-w-0 flex-1 border-0 bg-transparent px-0 text-sm text-(--foreground) outline-none placeholder:text-(--muted)"
          />
          <button
            type="submit"
