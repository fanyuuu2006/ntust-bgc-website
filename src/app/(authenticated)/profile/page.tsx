  ...
  if (!profile) {
    return (
      <section className="container max-w-3xl space-y-6 py-6 sm:py-8">
        <PageHeader title="個人檔案" description="查看網站帳號與個人資料。" />
        <Card className="p-5 sm:p-6">
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              <h2 className="wrap-break-word font-semibold text-(--text-primary)">
                個人資料暫時無法載入
              </h2>
              <p className="mt-1 wrap-break-word text-sm leading-6 text-(--text-muted)">
