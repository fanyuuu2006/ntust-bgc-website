...
Phase 3I 已建立最小 Public Profile 投影，詳見 [公開身份邊界](public-identity.md)。Review 公開作者投影只輸出必要公開欄位；closed user 固定顯示「已註銷使用者」、avatar=null，不輸出 email、Profile 或內部 tombstone email。評論可保留作者 UUID 維持脈絡，但註銷者的匿名化公開個人頁不提供集中式評論歷史。既有內容本身是否含個資須另行審查，不由作者名稱替換保證。
